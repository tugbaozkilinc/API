...
public class Get05 extends RestfulBookerHerOkuAppBaseUrl {
    ...
    */
    //https://restful-booker.herokuapp.com/booking?firstname=Sally&lastname=Brown ? isareti query params larin basladigi yeri ifade eder. / ile de path params lar baslatilir. 2 query params
    //& ile ayrilir.
