...
public class Post04 extends RestfulBookerHerOkuAppBaseUrl {
    ...
    */
    ...
    public void test() {
        ...
        RestfulBookerHerOkuAppBookingDatesPojo bookingDates = new RestfulBookerHerOkuAppBookingDatesPojo("2021-09-21", "2021-12-21");
        RestfulBookerHerOkuAppPojo expectedData = new RestfulBookerHerOkuAppPojo("Ali", "Can", 999, true, bookingDates, "Breakfast");
